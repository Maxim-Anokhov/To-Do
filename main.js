...
const tasksHigh_list = document.querySelector(".high").lastElementChild.firstElementChild.nextElementSibling.textContent;
const taskLow_list = document.querySelector(".low").lastElementChild.firstElementChild.nextElementSibling.textContent;
...
function getTaskName(event) {
    if (event) {
        ...
        console.log(id)
        createTask(event, taskName, id)
    } else {
        console.log(taskLow_list, tasksHigh_list)
    }
}

function createTask(event, taskName, id) {
